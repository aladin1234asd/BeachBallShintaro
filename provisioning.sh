...
Slow Generation:
- Use Lightning LoRA for faster inference
- Verify GPU utilization: nvidia-smi
- Reduce steps or image size

Model Not Found:
- Check model paths in workflows
...
RTX 4090:
- Layered (640px, 20 steps): ~45s
- Layered (1024px, 50 steps): ~2m 30s
- Edit Standard (40 steps): ~2m 15s
- Edit Lightning (4 steps): ~25s

A100 (40GB):
- Layered (640px, 20 steps): ~30s
- Layered (1024px, 50 steps): ~1m 45s
- Edit Standard (40 steps): ~1m 30s
- Edit Lightning (4 steps): ~18s
...
- Workflows: https://github.com/Comfy-Org/workflow_templates/issues
- Vast.ai: https://vast.ai/support

Generated by Qwen ComfyUI Provisioning Script
EOF
